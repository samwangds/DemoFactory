 ...
 * <p/>
 * <p/>
 * 2.1-2.3.5版本系统使用的ICU是2.4版本的
 * 4.0.3版本系统使用的ICU是4.6版本的
 */
public class HanziToPinyin {
    ...
    private static final char[] UNIHANS24 = {
            '\u5416', '\u54ce', '\u5b89', '\u80ae', '\u51f9', '\u516b', '\u63b0', '\u6273',
            '\u90a6', '\u52f9', '\u9642', '\u5954', '\u4f3b', '\u7680', '\u782d', '\u706c',
            '\u618b', '\u6c43', '\u51ab', '\u7676', '\u5cec', '\u5693', '\u5072', '\u53c2',
            '\u4ed3', '\u64a1', '\u518a', '\u5d7e', '\u564c', '\u6260', '\u62c6', '\u8fbf',
    ...
    private final static byte[][] PINYINS24 = {
     ...
     */
    private static final String FIRST_PINYIN_UNIHAN24 = "\u5416";
    private static final String LAST_PINYIN_UNIHAN24 = "\u5497";

    /**
     * Unihans array. Each unihans is the first one within same pinyin. Use it to determine pinyin
     * for all ~20k unihans.
     */
    public static final char[] UNIHANS46 = {
            '\u5475', '\u54ce', '\u5b89', '\u80ae', '\u51f9',
            '\u516b', '\u6300', '\u6273', '\u90a6', '\u5305', '\u5351', '\u5954', '\u4f3b',
            '\u5c44', '\u8fb9', '\u6807', '\u618b', '\u90a0', '\u69df', '\u7676', '\u5cec',
            '\u5693', '\u5a47', '\u98e1', '\u4ed3', '\u64cd', '\u518a', '\u5d7e', '\u564c',
     ...
     */
    public static final byte[][] PINYINS46 = {
     ...
     * First and last Chinese character with known Pinyin according to zh collation
     */
    private static final String FIRST_PINYIN_UNIHAN46 = "\u963F";
    private static final String LAST_PINYIN_UNIHAN46 = "\u84D9";

    public static final char[] UNIHANS = Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1 ? UNIHANS46 : UNIHANS24;
    public static final byte[][] PINYINS = Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1 ? PINYINS46 : PINYINS24;
    private static final String FIRST_PINYIN_UNIHAN = Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1 ? FIRST_PINYIN_UNIHAN46 : FIRST_PINYIN_UNIHAN24;
    private static final String LAST_PINYIN_UNIHAN = Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1 ? LAST_PINYIN_UNIHAN46 : LAST_PINYIN_UNIHAN24;
    ...
    public static HanziToPinyin getInstance() {
        synchronized (HanziToPinyin.class) {
            ...
            for (int i = 0; i < locale.length; i++) {
                //华为荣耀4X,找不到zh_CN
                if (TextUtils.equals(locale[i].getLanguage(),Locale.CHINA.getLanguage())) {
    ...
    private static boolean doSelfValidation() {
        ...
        for (char c : UNIHANS) {
            ...
            if (cmp >= 0) {
                Logger.w(TAG, "Internal error in Unihan table. " + "The last string \"" + lastString
    ...
    /**
     * 汉字转成拼音输出,每个汉字拼音首字母大写,其他小写
     *
     * @param input 文字
     * @return
     */
    public String getPinYinUpperLower(String input) {
        ArrayList<Token> tokens = get(input);
        StringBuilder sb = new StringBuilder();
        if (tokens != null && tokens.size() > 0) {
            for (Token token : tokens) {
                if (Token.PINYIN == token.type) {
                    sb.append(token.target.substring(0, 1).toUpperCase());
                    if (token.target.length() > 1) {
                        sb.append(token.target.substring(1).toLowerCase());
                    }
                } else {
                    sb.append(token.source);
                }
     ...
     * @return
     */
    public String getPinYinUpperLower(char c) {
        return getPinYinUpperLower(String.valueOf(c));
    }
}
